...
namespace ManagementStore.Extensions
{
    ...
    {
        private static readonly bool _useAspNetCore;
        private static readonly byte _formatMarker;
        private static readonly KeyDerivationPrf _prf; // Requires Microsoft.AspNetCore
        private static readonly HashAlgorithmName _hashAlgorithmName;
        private static readonly bool _includeHeaderInfo;
        private static readonly int _saltLength;
        private static readonly int _requestedLength;
        private static readonly int _iterCount;
        static PasswordExtensions()
        {
            _useAspNetCore = true;
